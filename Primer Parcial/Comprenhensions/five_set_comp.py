...
def run():
    ...
    print(("\n4. Conjunto complemento de las plataformas que pertenecen a los resultados del ejercicio 1 de la sección anterior y el conjunto de la llamada a la función conjunto_q(f)."))
    pprint(set(list(D)[:5]))
    ...
    print(("\n5. Conjunto conjunto de tuplas donde las ventas de los juegos que se encuentren en el conjunto del ejercicio 3 de la sección anterior y en el conjunto de la llamda a la función conjunto_u(f)."))
    pprint(set(list(E)[:5]))
